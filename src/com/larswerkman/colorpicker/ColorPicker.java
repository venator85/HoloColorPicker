	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			case MotionEvent.ACTION_DOWN:
				...
				float[] pointerPosition = calculatePointerPosition(mAngle);
				if (x >= pointerPosition[0] - mColorPointerHaloRadius && x <= pointerPosition[0] + mColorPointerHaloRadius
						&& y >= pointerPosition[1] - mColorPointerHaloRadius && y <= pointerPosition[1] + mColorPointerHaloRadius) {
